"""
Silence-based audio slicer for singing voice conversion.
Splits long audio at silence boundaries into independent segments.
"""
...
def cross_fade(a: np.ndarray, b: np.ndarray, idx: int):
    result = np.zeros(idx + b.shape[0], dtype=a.dtype)
